...
avioes = [Aviao('BOIENG456', 1500, 400), Aviao('Embraer Praetor', 863, 14), Aviao('Antonov An-2', 258, 12)]

for aviao in avioes:
    print(f'modelo {aviao.modelo}: velocidade máxima {aviao.velocidade_maxima} km/h: capacidade para {aviao.capacidade} passageiros: Cor {aviao.cor}')