...
class Lampada:
    def __init__(self, ligada) -> None: #__init__ que recebe valore booleanos
        self.ligada = ligada
...
lampada = Lampada(False)#começa desligada

lampada.liga() #Liga a lampada
print('A lâmpada está ligada?', lampada.esta_ligada())

lampada.desliga() #Desliga a lampada
print('A lâmpada está ligada?', lampada.esta_ligada())